...
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center">
      <img src={LargeLogo} alt="logo" className="mb-8 w-1/2 max-w-[200px]" />
      <div className="flex flex-col items-center drop-shadow-lg rounded-md bg-white py-8 w-11/12 max-w-[700px]">
